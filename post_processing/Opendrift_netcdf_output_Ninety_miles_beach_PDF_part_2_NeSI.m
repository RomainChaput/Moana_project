...
addpath '/nesi/nobackup/vuw03295/Regional_project/Ninety_miles_beach/outputs_backward_2'
...
traj_output=dir('/nesi/nobackup/vuw03295/Regional_project/Ninety_miles_beach/outputs_backward_2/ninety_miles_beach_backward*');
%ncdisp(traj_output) % Check the attributes of the netcdf file
...
save('frequency_release.mat','frequency_release_backward');
save('disp_release.mat','disp_release_backward','-v7.3');
save('frequency_settlement.mat','frequency_habitat_backward');
save('disp_settlement.mat','disp_settlement_backward','-v7.3');
