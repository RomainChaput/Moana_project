...
o.seed_elements(plon, plat, 
                      number=tot_parts, 
                      z=z,
                      time = [datetime(2017,6,25), datetime(2017,6,30)],
...
o.run(stop_on_error=False,
      time_step=900.0, 
      end_time = (datetime(2017,6,30) + timedelta(days = 36.0)),
      outfile= '/nesi/nobackup/vuw03295/ninety_miles_beach_foreward_1_june_4_2017_005deg_Moana_mask.nc',
