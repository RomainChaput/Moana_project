...
o.set_config('drift:max_age_seconds', 15*24*3600) # 
o.set_config('biology:min_settlement_age_seconds', 10*24*3600) # Beginning of the competency period
...
o.set_config('biology:OVM', False)
...
o.set_config('biology:flexion', 5.0*24*3600)# Beginning of the flexion stage. Beginning of the orientation
o.set_config('biology:post_flexion', 10.0*24*3600)# Beginning of the post-flexion stage
...
o.set_config('biology:flexion', 10.0*24*3600)# Beginning of the flexion stage. Beginning of the orientation => if using OVM, values must agree
o.set_config('biology:max_orient_distance', 100.0)# Orientation distance in kilometers. Maximum distance at which the habitat is detected
# Horizontal swimming speed:
o.set_config('biology:hatch_swimming_speed', 200.1)# Swimming speed at hatching, in cm/s
o.set_config('biology:settle_swimming_speed', 300.0)# Swimming speed at settlement, in cm/s
