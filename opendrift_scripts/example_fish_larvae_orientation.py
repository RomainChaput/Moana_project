...
o.habitat('./habitat/Polygons_reefs.shp') # Location of the shapefile with the habitat
o.set_config('biology:orientation', 'continuous_2') # orientation of the larvae: direct, rheotaxis, cardinal, continuous_1 (rheo + direct), continuous_2 (card + direct), or none
o.set_config('biology:beginning_orientation', 10.0*24*3600)# Beginning of the orientation => if using OVM, values must agree
...
o.set_config('biology:cardinal_heading', 180.0)# Cardinal heading for larval orientation when 'cardinal' or 'continuous_2' options are selected
