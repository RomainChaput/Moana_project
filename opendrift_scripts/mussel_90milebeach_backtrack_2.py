...
points = np.loadtxt('./Second_backtrack_input_files/Release_Ninety_miles_beach_backtrack2_high_dens_500mbuff.xyz', delimiter='\t', dtype=str)
...
#lat0 = -37.855
#radius_in_m = 1000
z = np.random.uniform(-30,0,size=tot_parts) # generate random depth
#z = 'seafloor+1'
...
o.seed_elements(plon, plat, 
                      number=tot_parts, 
                      z=z,
                      time = [datetime(2017,9,30), datetime(2017,9,1)])
...
o.run(stop_on_error=False,
      time_step=-900.0, 
      end_time = (datetime(2017,9,1) - timedelta(days = 35.0)),
      outfile= 'ninety_miles_beach_backward_2_sept_2017_2.nc',
